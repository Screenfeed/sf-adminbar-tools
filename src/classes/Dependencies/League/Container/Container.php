...
use Screenfeed\AdminbarTools\Dependencies\League\Container\Argument\RawArgumentInterface;
use Screenfeed\AdminbarTools\Dependencies\League\Container\Definition\DefinitionFactory;
use Screenfeed\AdminbarTools\Dependencies\League\Container\Definition\DefinitionFactoryInterface;
use Screenfeed\AdminbarTools\Dependencies\League\Container\Definition\DefinitionInterface;
use Screenfeed\AdminbarTools\Dependencies\League\Container\Exception\NotFoundException;
use Screenfeed\AdminbarTools\Dependencies\League\Container\Inflector\InflectorAggregate;
use Screenfeed\AdminbarTools\Dependencies\League\Container\Inflector\InflectorAggregateInterface;
use Screenfeed\AdminbarTools\Dependencies\League\Container\ServiceProvider\ServiceProviderAggregate;
use Screenfeed\AdminbarTools\Dependencies\League\Container\ServiceProvider\ServiceProviderAggregateInterface;

class Container implements ContainerInterface
{
    /**
     * @var \Screenfeed\AdminbarTools\Dependencies\League\Container\Definition\DefinitionFactoryInterface
     */
    protected $definitionFactory;

    /**
     * @var \Screenfeed\AdminbarTools\Dependencies\League\Container\Definition\DefinitionInterface[]
     */
    ...
    /**
     * @var \Screenfeed\AdminbarTools\Dependencies\League\Container\Inflector\InflectorAggregateInterface
     */
    protected $inflectors;

    /**
     * @var \Screenfeed\AdminbarTools\Dependencies\League\Container\ServiceProvider\ServiceProviderAggregateInterface
     */
    protected $providers;
     ...
     * Constructor.
     *
     * @param \Screenfeed\AdminbarTools\Dependencies\League\Container\ServiceProvider\ServiceProviderAggregateInterface|null $providers
     * @param \Screenfeed\AdminbarTools\Dependencies\League\Container\Inflector\InflectorAggregateInterface|null             $inflectors
     * @param \Screenfeed\AdminbarTools\Dependencies\League\Container\Definition\DefinitionFactoryInterface|null             $definitionFactory
     */

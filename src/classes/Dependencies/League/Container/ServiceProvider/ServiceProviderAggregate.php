...
use Screenfeed\AdminbarTools\Dependencies\League\Container\ContainerAwareTrait;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider)
    {
        ...
        throw new \InvalidArgumentException(
            ...
            'of (\Screenfeed\AdminbarTools\Dependencies\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }

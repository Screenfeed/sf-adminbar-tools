...
abstract class ScreenfeedAdminbarTools_Mustache_Logger_AbstractLogger implements ScreenfeedAdminbarTools_Mustache_Logger
{
    ...
    {
        $this->log(ScreenfeedAdminbarTools_Mustache_Logger::EMERGENCY, $message, $context);
    }
    ...
    {
        $this->log(ScreenfeedAdminbarTools_Mustache_Logger::ALERT, $message, $context);
    }
    ...
    {
        $this->log(ScreenfeedAdminbarTools_Mustache_Logger::CRITICAL, $message, $context);
    }
    ...
    {
        $this->log(ScreenfeedAdminbarTools_Mustache_Logger::ERROR, $message, $context);
    }
    ...
    {
        $this->log(ScreenfeedAdminbarTools_Mustache_Logger::WARNING, $message, $context);
    }
    ...
    {
        $this->log(ScreenfeedAdminbarTools_Mustache_Logger::NOTICE, $message, $context);
    }
    ...
    {
        $this->log(ScreenfeedAdminbarTools_Mustache_Logger::INFO, $message, $context);
    }
    ...
    {
        $this->log(ScreenfeedAdminbarTools_Mustache_Logger::DEBUG, $message, $context);
    }
}

 ...
 * current context.
 */
class ScreenfeedAdminbarTools_Mustache_LambdaHelper
{
    private $mustache;
    private $context;
    private $delims;
     ...
     */
    public function __construct(ScreenfeedAdminbarTools_Mustache_Engine $mustache, ScreenfeedAdminbarTools_Mustache_Context $context, $delims = null)
    {
     ...
     *
     * @return ScreenfeedAdminbarTools_Mustache_LambdaHelper
     */

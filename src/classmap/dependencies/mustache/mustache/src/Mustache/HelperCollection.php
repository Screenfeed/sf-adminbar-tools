...
class ScreenfeedAdminbarTools_Mustache_HelperCollection
{
    ...
    public function __construct($helpers = null)
    {
        ...
        if (!is_array($helpers) && !$helpers instanceof Traversable) {
            throw new ScreenfeedAdminbarTools_Mustache_Exception_InvalidArgumentException('HelperCollection constructor expects an array of helpers');
        }
    ...
    {
        if (!$this->has($name)) {
            throw new ScreenfeedAdminbarTools_Mustache_Exception_UnknownHelperException($name);
        }
     ...
     * Check whether a given helper is present in the collection.
     *
     * @throws ScreenfeedAdminbarTools_Mustache_Exception_UnknownHelperException if the requested helper is not present
     *
     * @param string $name
     */

 ...
 * @abstract
 */
abstract class ScreenfeedAdminbarTools_Mustache_Template
{
    /**
     * @var ScreenfeedAdminbarTools_Mustache_Engine
     */
    protected $mustache;
     ...
     */
    public function __construct(ScreenfeedAdminbarTools_Mustache_Engine $mustache)
    {
     ...
     * @return string Rendered template
     */
    abstract public function renderInternal(ScreenfeedAdminbarTools_Mustache_Context $context, $indent = '');
     ...
     *
     * @return ScreenfeedAdminbarTools_Mustache_Context
     */
    protected function prepareContextStack($context = null)
    {
        $stack = new ScreenfeedAdminbarTools_Mustache_Context();
     ...
     * @return string
     */
    protected function resolveValue($value, ScreenfeedAdminbarTools_Mustache_Context $context)
    {

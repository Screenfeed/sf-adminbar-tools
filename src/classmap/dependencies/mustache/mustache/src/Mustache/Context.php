 ...
 */
class ScreenfeedAdminbarTools_Mustache_Context
{
    private $stack      = array();
     ...
     *
     * @throws ScreenfeedAdminbarTools_Mustache_Exception_InvalidArgumentException if given an invalid anchored dot $id
     *
     * @param string $id Dotted variable selector
     *
     * @return mixed Variable value, or '' if not found
    ...
    public function findAnchoredDot($id)
    {
        ...
        $first  = array_shift($chunks);
        if ($first !== '') {
            throw new ScreenfeedAdminbarTools_Mustache_Exception_InvalidArgumentException(sprintf('Unexpected id for findAnchoredDot: %s', $id));
        }

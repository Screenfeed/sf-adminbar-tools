...
class ScreenfeedAdminbarTools_Mustache_Tokenizer
{
    ...
    private function changeDelimiters($text, $index)
    {
        ...
        } catch (ScreenfeedAdminbarTools_Mustache_Exception_InvalidArgumentException $e) {
            throw new ScreenfeedAdminbarTools_Mustache_Exception_SyntaxException($e->getMessage(), $token);
        }
    ...
    private function setDelimiters($delimiters)
    {
        if (!preg_match('/^\s*(\S+)\s+(\S+)\s*$/', $delimiters, $matches)) {
            throw new ScreenfeedAdminbarTools_Mustache_Exception_InvalidArgumentException(sprintf('Invalid delimiters: %s', $delimiters));
        }

 ...
 */
class ScreenfeedAdminbarTools_Mustache_Exception_UnknownFilterException extends UnexpectedValueException implements ScreenfeedAdminbarTools_Mustache_Exception
{
